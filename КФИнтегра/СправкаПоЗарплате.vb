...
WHERE Сотрудники.КодСотрудники=@КодСотрудники", list)
        ...
        If MessageBox.Show("Справка оформлена!" & vbCrLf & "Распечатать?", Рик, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ПечатьДоковFTP(massFTP)
        End If
        Статистика(ComboBox2.Text, "Оформление справки по месту требования на 4 месяца", ComboBox1.Text)
        Me.Cursor = DefaultCursor
...
WHERE Сотрудники.КодСотрудники=@КодСотрудники", list)
        ...
        If MessageBox.Show("Справка оформлена!" & vbCrLf & "Распечатать?", Рик, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ПечатьДоковFTP(massFTP)
        End If
        Статистика(ComboBox2.Text, "Оформление справки по месту требования на 5 месяцев", ComboBox1.Text)
        Me.Cursor = DefaultCursor
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Select Case CType(ComboBox10.Text, Integer)
            Case 3
                доки3()
                Статистика(ComboBox2.Text, "Оформление справки по месту требования на 3 месяца", ComboBox1.Text)
                Exit Sub
            Case 4
                доки4()
                Статистика(ComboBox2.Text, "Оформление справки по месту требования на 4 месяца", ComboBox1.Text)
...
WHERE Сотрудники.КодСотрудники=@КодСотрудники", list)
        ...
        End If
        Статистика(ComboBox2.Text, "Оформление справки по месту требования", ComboBox1.Text)
        Me.Cursor = DefaultCursor
